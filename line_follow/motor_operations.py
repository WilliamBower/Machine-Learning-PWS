...
class Leaphy():
    ...
    def l_turn(self, percentage=1, speed=1): 
        ...
        print(f"{self.LTurnL*percentage*speed} | {self.LTurnR*percentage*speed}")
    ...
    def r_turn(self, percentage=1, speed=1): 
        ...
        print(f"{self.RTurnL*percentage*speed} | {self.RTurnR*percentage*speed}")
